...
def main():
    """this is a 2D version of the dUdt calculator script"""
...
def getU(t):
    ...
    THIS METHOD IS DESIGNED TO WORK WITH THE 2D SYSTEMS.  BOUNDARY NAMING CONVENTION IS A BIT DIFFERENT IN THE 3D SYSTEMS
    '''
